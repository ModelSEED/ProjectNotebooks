...
class MSSmetana:
    ...
    def sc_score(self):
        self.sc = MSSmetana.sc(self.community, self.models, self.min_growth, self.n_solutions, self.abstol, compatibilize=self.compatibilize)
        if self.printing:
    ...
    def smetana_score(self):
        ...
        self.smetana = MSSmetana.smetana(self.community, self.models,
            self.min_growth, self.n_solutions, self.abstol, (self.sc, self.mu, self.mp), self.media)
        return self.smetana
    ...
    @staticmethod
    def sc(com_model=None, cobra_models:Iterable=None, min_growth=0.1, n_solutions=100, abstol=1e-6, compatibilize=True):
    ...
    @staticmethod
    def smetana(com_model=None, cobra_models: Iterable, min_growth=0.1, n_solutions=100, abstol=1e-6,
