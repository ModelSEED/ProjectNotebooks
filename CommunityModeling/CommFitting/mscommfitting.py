...
class MSCommFitting(): 
    ...
    def define_problem(self, parameters={}, zip_name:str=None, export_parameters:bool=True, export_lp:bool=True, flexible_consumption:float=None, metabolites_to_track:list=None):
                            ...
                            if final_time and met_id in self.parameters['carbon_sources']:
                                ...
                                if flexible_consumption:
                                    ...
                                    self.variables["c_"+met][time][trial] = Variable(
                                        ...
                                        lb=0, ub=self.variables["c_"+met]["1"][trial].lb*flexible_consumption)
